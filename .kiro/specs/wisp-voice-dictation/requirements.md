...
13. THE Whisper_Service SHALL store all downloaded Whisper_Model files under `Application Support/wispr/` (the app's sandbox container) so that models reside in a sandbox-compatible location managed by the OS.
